...
class AboutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create about" do
    assert_difference('About.count') do
      post abouts_url, params: { about: { bio: @about.bio, contact: @about.contact, name: @about.name } }
    end
  ...
  test "should update about" do
    patch about_url(@about), params: { about: { bio: @about.bio, contact: @about.contact, name: @about.name } }
